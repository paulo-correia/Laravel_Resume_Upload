...
return [
    ...
    */
    ...
    'max'                  => [
        ...
        'file'    => 'O Arquivo não deve ter mais que :max kilobytes.',
        'string'  => ':Attribute não deve ter mais que :max caracteres.',
        'array'   => ':Attribute não deve ter mais que :max itens.',
    ],
    'mimes'                => 'O Arquivo deve ser um arquivo do tipo: :values.',
    'mimetypes'            => 'O Arquivo deve ser um arquivo do tipo: :values.',
    'min'                  => [
